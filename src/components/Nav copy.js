        ...
        <nav className="relative py-6 bg-gray-50">
            <div className="container mx-auto px-4 flex justify-between items-center">
                <a className="text-3xl font-bold leading-none" href="#">
                    <img className="h-12" src="atis-assets/logo/atis/omahony-mono-black.png" alt="" width="auto" />
                </a>
                ...
                <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
                    <li><NavLink className="text-sm text-gray-400 hover:text-gray-500" to="/landing" activeClassName="text-green-600 font-bold ">Home</NavLink></li>
                    ...
                    <li><NavLink className="text-sm text-gray-400 hover:text-gray-500" to="/about" activeClassName="text-green-600 font-bold ">About Us</NavLink></li>
                    <li className="text-gray-300">
                        <svg className="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                        </svg>
                    </li>
                    <li><NavLink className="text-sm text-gray-400 hover:text-gray-500" to="/services" activeClassName="text-green-600 font-bold ">Services</NavLink></li>
                    <li className="text-gray-300">
                        <svg className="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                        </svg>
                    </li>
                    <li><NavLink className="text-sm text-gray-400 hover:text-gray-500" to="/grants" activeClassName="text-green-600 font-bold ">Grants</NavLink></li>
                    <li className="text-gray-300">
                        <svg className="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                        </svg>
                    </li>
                    <li><NavLink className="text-sm text-gray-400 hover:text-gray-500" to="/faqs" activeClassName="text-green-600 font-bold ">FAQs</NavLink></li>

                </ul>
                <a className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold rounded-l-xl rounded-t-xl transition duration-200" href="#">Call Us</a>
                <NavLink className="hidden lg:inline-block py-2 px-6 bg-green-500 hover:bg-green-600 text-sm text-white font-bold rounded-l-xl rounded-t-xl transition duration-200" to="/get-quote">Free Estimate</NavLink>
            </div>
        </nav>
...
{/*<nav className="relative py-6 bg-gray-50"><div className="container mx-auto px-4 flex justify-between items-center">
        <a className="text-3xl font-bold leading-none" href="#">
            <img className="h-12" src="atis-assets/logo/atis/omahony-mono-black.png" alt="" width="auto" /></a>
        <div className="lg:hidden">
            <button className="navbar-burger flex items-center text-green-600 p-3" >
        ...
        </ul><a className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-white hover:bg-gray-200 text-sm text-gray-900 font-bold rounded-l-xl rounded-t-xl transition duration-200" href="#">Contact Us</a><a className="hidden lg:inline-block py-2 px-6 bg-green-500 hover:bg-green-600 text-sm text-white font-bold rounded-l-xl rounded-t-xl transition duration-200" href="#">Free Estimate</a>
    </div>
</nav>*/}
